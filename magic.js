let magic = {
  ...
  "Elemental Gem": {
    ...
    "type": "Consumable Items",
    "group": "Magic",
    "description": "This gem contains a mote of elemental energy. When you use an action to break the gem,(Based on the color of the gem) an air, fire, earth, or water elemental is summoned as if you had cast the conjure elemental spell, and the gem's magic is lost.",
    "form": "Wondrous"
  },
  "Necklace of Fireballs (1 bead)": {
    ...
    "type": "Consumable Items",
    "group": "Magic",
    "description": "This necklace has 1d6 + 3 beads hanging from it. You can use an action to detach a bead and throw it up to 6 feet away. When it reaches the end of its trajectory, the bead detonates as a 3rd-level fireball spell (save DC 15).\n\nYou can hurl multiple beads, or even the whole necklace, as one action. When you do so, increase the level of the fireball by 1 for each bead beyond the first.",
    "form": "Wondrous"
  },
  ...
  "Manual of Sharpened Mind": {
    "price": "55,000 gp",
    "rarity": "Very Rare",
    "type": "Consumable Items",
    "group": "Magic",
    "description": "This book contains memory and mental exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Intelligence score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century.",
    "form": "Wondrous"
  },
  "Manual of Glamour and Prestige": {
    "price": "55,000 gp",
    "rarity": "Very Rare",
    "type": "Consumable Items",
    "group": "Magic",
    "description": "This book contains tactical and prediction exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Wisdom score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century.",
    "form": "Wondrous"
  },
  "Manual of Prudent Foresight": {
    "price": "55,000 gp",
    "rarity": "Very Rare",
    "type": "Consumable Items",
    "group": "Magic",
    "description": "This book contains social and mannerism exercises, and its words are charged with magic. If you spend 48 hours over a period of 6 days or fewer studying the book's contents and practicing its guidelines, your Charisma score increases by 2, as does your maximum for that score. The manual then loses its magic, but regains it in a century.",
    "form": "Wondrous"
  },
  "Helm of Comprehend Languages": {
    "price": "500 gp",
    "rarity": "Uncommon",
    "type": "Non Combat Items",
    "group": "Magic",
  ...
  "Rod of Ressurection": {
    ...
    "type": "Non Combat Items",
    "group": "Magic",
    "description": "The rod has 5 charges,while holding it you can use an action to cast one of the following spells; Heal (expends one charge) or Ressurection (expends 5 charges)\nThe rod gains 1 expended charge daily at dawn, if the rod is reduced to zero charges roll 1d20, on a 1 the rod disappears in a burst of radiance.\n\n(Requires Attunement by Cleric, Druid, or Paladin)",
    "form": "Rod"
  },
  "Ivory Goat (Travail)": {
    "price": "400 gp",
  ...
  "Obsidian Steed": {
    ...
    "type": "Summons / Pets",
    "group": "Magic",
    "description": "This polished obsidian horse can become a nightmare for up to 24 hours. The nightmare fights only to defend itself. Once it has been used, it can't be used again until 5 days have passed.\n\nIf you have a good alignment, the figurine has a 10 percent chance each time you use it to ignore your orders, including a command to revert to figurine form. If you mount the nightmare while it is ignoring your orders, you and the nightmare are instantly transported to a random location on the plane of Hades, where the nightmare reverts to figurine form.",
    "form": "Wondrous"
  },
  "(+1) Weapon": {
    "price": "700 gp",
  ...
  "Vicious Weapon": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "When you roll a 20 with this magic weapon, the target takes an extra 7 of its damage type",
    "form": "Weapon"
  },
  ...
  "Dancing Sword": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "You can use a bonus action to toss this magic sword into the air and speak the command word. When you do so, the sword begins to hover, flies up to 30 feet, and attacks one creature of your choice within 5 feet of it. The sword uses your attack roll and ability score modifier for damage rolls.\n\nWhile the sword hovers, you can use a bonus action to cause it to fly up to 30 feet to another spot within 30 feet of you. As part of the same bonus action, you can cause the sword to attack one creature within 5 feet of it.\n\nAfter the hovering sword attacks for the fourth time, it flies up to 30 feet and tries to return to your hand. If you have no hand free, it falls to the ground at your feet. If the sword has no unobstructed path to you, it moves as close to you as it can and then falls to the ground. It also ceases to hover if you grasp it or move more than 30 feet away from it.",
    "form": "Weapon"
  },
  "Sword of Wounding": {
    "price": "2,000 gp",
  ...
  "Ioun Stone Protection": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect.\n\nA stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head.\n\nProtection.\n\nYou gain a +1 bonus to AC while this dusty rose prism orbits your head.\n",
    "form": "Wondrous"
  },
  "Ioun Stone Reserve": {
    "price": "1,500 gp",
  ...
  "Armor of Resistance": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "You have resistance to a type of damage while you wear this armor.\n\n(Acid, Cold, Fire, Force, Lightning, Necrotic, Poison, Psychic, Radiant, Thunder)\n\n",
    "form": "Armor"
  },
  "Adamantine Armor": {
    "price": "Armor + 500 gp",
  ...
  "Dragon Scale Mail": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued. While wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to damage based on the color of the scales\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest same scaled dragon within 30 miles of you. This special action can't be used again until the next dawn.\n",
    "form": "Armor"
  },
  "Dwarven Plate": {
    "price": "6,000 gp",
  ...
  "Belt of Hill Giant Strength": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "While wearing this belt, your Strength score changes to 21. The item has no effect on your if your Strength without the belt is equal to or greater than the belt's score.\n",
    "form": "Wondrous"
  },
  "Belt of Stone Giant Strength": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "While wearing this belt, your Strength score changes to 23. The item has no effect on your if your Strength without the belt is equal to or greater than the belt's score.\n",
    "form": "Wondrous"
  },
  ...
  "Belt of Fire Giant Strength": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "While wearing this belt, your Strength score changes to 25. The item has no effect on your if your Strength without the belt is equal to or greater than the belt's score.\n",
    "form": "Wondrous"
  },
  "Belt of Cloud Giant Strength": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "While wearing this belt, your Strength score changes to 27. The item has no effect on your if your Strength without the belt is equal to or greater than the belt's score.\n",
    "form": "Wondrous"
  },
  "Belt of Storm Giant Strength": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "While wearing this belt, your Strength score changes to 29. The item has no effect on your if your Strength without the belt is equal to or greater than the belt's score.\n",
    "form": "Wondrous"
  },
  "Bracers of Defense": {
    "price": "4,000 gp",
  ...
  "Pearl of Power": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "While this pearl is on your person, you can use an action to speak its command word and regain one expended spell slot. If the expended slot of of 4th level or higher, the new slot is 3rd level. Once you have used the pearl, it can't be used again until the next dawn.\n",
    "form": "Wondrous"
  },
  "Pipes of Haunting": {
    "price": "600 gp",
  ...
  "Prayer Bead - Bless": {
    ...
    "type": "Combat Items",
    "group": "Magic",
    "description": "This necklace has a magic bead made from aquamarine, black pearl, or topaz. It also has many nonmagical beads made from stones such as amber, bloodstone, citrine, coral, jade, pearl, or quartz. If a magic bead is removed from the necklace, that bead loses its magic.\n\nA necklace can have more than one bead of the same type. To use one, you must be wearing the necklace. Each bead contains a spell that you can cast from it as a bonus action (using your spell save DC if a save is necessary). Once a magic bead's spell is cast, that bead can't be used again until the next dawn.\n\nBless spell\n\n(requires attunement by a cleric, druid, or paladin)",
    "form": "Wondrous"
  },
  "Prayer Bead - Smiting": {
    "price": "300 gp",
  ...
  "Prayer Bead - Greater Restoration": {
    "price": "2,500 gp",
    "rarity": "Rare",
    "type": "Combat Items",
    "group": "Magic",
